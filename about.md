...
#### Note:
The source codes for ui.R and server.R files are also available on the [GitHub repo](https://github.com/jamalparit/coursera-final-submission)

Presentation Slide decks are available on the [RPubs page](http://rpubs.com/jamalparit/capstone)
